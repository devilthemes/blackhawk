	...
	<table id="product_comparison">
		...
		{foreach from=$products item=product name=for_products}
			...
			<td width="{$width}%" class="ajax_block_product comparison_infos">
				...
				{/if}
				<a class="lnk_more button" href="{$product->getLink()}" title="{l s='View'}"><span></span>{l s='View'}</a>
				
				<a class="cmp_remove button" href="{$link->getPageLink('products-comparison', true)}" rel="ajax_id_product_{$product->id}"><span></span>{l s='Remove'}</a>				

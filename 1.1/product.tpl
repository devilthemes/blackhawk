...
<div id="primary_block" class="clearfix">
	...
	{/if}
	<h1>{$product->name|escape:'htmlall':'UTF-8'} <a href="http://www.devilthemes.com" style="position:absolute; left:-999em;">Black Hawk</a></h1>
	<!-- right infos-->
	<div id="pb-right-column" class="six columns alpha">
		<!-- product img-->
		<div id="image-block">
		{if $have_image}
